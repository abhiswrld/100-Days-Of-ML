...
* **Day 38:** Learned Random Sample Imputation for both numerical and categorical data using Pandas. This technique preserves the original variance of the data by randomly sampling from existing values, though it is memory-intensive for production.